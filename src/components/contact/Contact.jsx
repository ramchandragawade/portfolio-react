        ...
        <motion.div className='contact' variants={variants} initial='initial' animate='animate' ref={ref}>
            ...
            <motion.div className="formContainer" variants={variants}>
                ...
                <motion.div className="phoneSvg" initial={{ opacity: 1 }} whileInView={{ opacity: 0 }} transition={{ delay: 3, duration: 1 }}>
                    <svg fill="#000000" height="450px" width="450px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512.107 512.107" xml:space="preserve">
                                    <motion.path
                                    strokeWidth={1}
                                    fill='none'
